...
const News = () => {
    ...
    const { id } = useParams()
    const newsDetail = newsDetails.find(aNews => aNews._id === id)
    const { title, image_url, details, author } = newsDetail;
    return (
        <div>
            <Header></Header>
            <Navbar></Navbar>
            <div className="grid md:grid-cols-4 gap-8">
                <div className="col-span-3">
                    <h2>News details</h2>
                    <div className="flex flex-col p-6 space-y-6 mb-10 overflow-hidden rounded-lg shadow-md dark:bg-gray-50 dark:text-gray-800">
